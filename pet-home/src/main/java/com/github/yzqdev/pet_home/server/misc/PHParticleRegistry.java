...
public class PHParticleRegistry {
    ...
    public static final DeferredHolder<ParticleType<?>, SimpleParticleType> LANTERN_BUGS = DEF_REG.register("lantern_bugs", () -> new SimpleParticleType(false));
    public static final DeferredHolder<ParticleType<?>, SimpleParticleType> QUESTION_MARK_PARTICLE_TYPE = DEF_REG.register("question_mark_particle", () -> new SimpleParticleType(false));
