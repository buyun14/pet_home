...
public class ParticleDeflectionShield extends Particle {
    ...
    public void render(VertexConsumer vertexConsumer, Camera camera, float partialTick) {
        ...
        Minecraft.getInstance().getItemRenderer().renderStatic(new ItemStack(PHItemRegistry.DEFLECTION_SHIELD.get()), ItemDisplayContext.GROUND, 240, OverlayTexture.NO_OVERLAY, posestack, multibuffersource$buffersource, level, 0);
